...
--
-- Host: localhost    Database: rostelecom
-- ------------------------------------------------------
...
INSERT INTO `authorization` VALUES (1,'admin',3,NULL,'admin','admin','admin','admin');
...
CREATE TABLE `t_specact` (
  ...
  `price` int NOT NULL,
  `dateArend` varchar(45) DEFAULT NULL,
...
--
-- Dumping routines for database 'rostelecom'
--
...
T1.Equip1,T1.stateequip1,T1.serialscore1,T1.price,T1.pricearenda,T1.arenda,T1.reasons
FROM
(SELECT concat(s_typeequip.typeequip," ",t_sklad.equipment) as 'Equip1' , s_stateequip.stateequip as 'stateequip1', t_specact.serialscore as 'serialscore1',
    t_specact.price as 'price',t_specact.price/t_akt.arenda as 'pricearenda',t_akt.arenda,s_reasons.reasons
     FROM t_specact, t_akt, t_dogovor, t_sklad,s_typeequip, s_stateequip,s_reasons
...
(SELECT s_city.gorod,t_akt.date,t_abonent.fioabonent,t_dogovor.nomdogovor,t_dogovor.date as 'date1',concat(s_typeequip.typeequip," ",t_sklad.equipment) as 'Equip' ,t_specact.serialscore,t_akt.stoimost
     FROM t_specact, t_akt, t_dogovor, t_sklad,s_typeequip, s_stateequip, t_facialscore, t_abonent,s_street,s_city
     WHERE t_specact.id_act = t_akt.id_akt and t_specact.id_skladequip = t_sklad.id_skladequip and t_specact.id_stateequip = s_stateequip.id_stateequip 
    and t_sklad.id_typeequip = s_typeequip.id_typeequip and t_akt.id_dogovor = t_dogovor.id_dogovor and t_dogovor.id_facialscore = t_facialscore.id_facialscore 
...
T1.Equip1,T1.stateequip1,T1.serialscore1,T1.price,T1.stoimost,T1.reasons
FROM
(SELECT concat(s_typeequip.typeequip," ",t_sklad.equipment) as 'Equip1' , s_stateequip.stateequip as 'stateequip1', t_specact.serialscore as 'serialscore1',
    t_specact.price as 'price', t_akt.stoimost,s_reasons.reasons
     FROM t_specact, t_akt, t_dogovor, t_sklad,s_typeequip, s_stateequip,s_reasons
     WHERE t_specact.id_act = t_akt.id_akt and t_specact.id_skladequip = t_sklad.id_skladequip and t_specact.id_stateequip = s_stateequip.id_stateequip 
    and t_sklad.id_typeequip = s_typeequip.id_typeequip and t_akt.id_dogovor = t_dogovor.id_dogovor and t_akt.id_typeact = 1
    and t_specact.id_reasons = s_reasons.id_reasons
    and t_dogovor.id_dogovor = NomDogovor and t_akt.nomact = NomAct) T1,
(SELECT s_city.gorod,t_akt.date,t_abonent.fioabonent,t_dogovor.nomdogovor,t_dogovor.date as 'date1',concat(s_typeequip.typeequip," ",t_sklad.equipment) as 'Equip' ,t_specact.serialscore
     FROM t_specact, t_akt, t_dogovor, t_sklad,s_typeequip, s_stateequip, t_facialscore, t_abonent,s_street,s_city
     WHERE t_specact.id_act = t_akt.id_akt and t_specact.id_skladequip = t_sklad.id_skladequip and t_specact.id_stateequip = s_stateequip.id_stateequip 
    and t_sklad.id_typeequip = s_typeequip.id_typeequip and t_akt.id_dogovor = t_dogovor.id_dogovor and t_dogovor.id_facialscore = t_facialscore.id_facialscore 
...
-- Dump completed on 2020-05-17  9:14:42
